...
(function () {
    ...
    UEDITOR_CONFIG = {
        imagePath:URL + "", //图片文件夹所在的路径，用于显示时修正后台返回的图片url！具体图片保存路径需要在后台设置。！important
        ...
        iframeUrlMap:{
            ...
            'highlightcode':'ueditor/dialogs/code/code.html',
        ...
        iframeCssUrl:'../ueditor/themes/default/iframe.css', //要引入css的url
        ...
        codeMirrorJsUrl:URL + "../ueditor/third-party/codemirror2.15/codemirror.js",
        codeMirrorCssUrl:URL + "../ueditor/third-party/codemirror2.15/codemirror.css",
